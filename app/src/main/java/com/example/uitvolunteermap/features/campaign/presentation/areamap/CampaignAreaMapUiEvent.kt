...
sealed interface CampaignAreaMapUiEvent {
    ...
    data class MapTapped(val latitude: Double, val longitude: Double) : CampaignAreaMapUiEvent
    data object LocationUnavailable : CampaignAreaMapUiEvent
    data class ConfirmLocation(val teamId: Int, val teamName: String, val name: String) : CampaignAreaMapUiEvent
